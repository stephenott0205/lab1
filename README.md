...
You will also need to provide the Project SDK, select the Java 1.7 SDK that should be installed on the machine(this can alternatively be done from the intellij welcome screen, under Configure -> Project Defaults -> Project Structure).

    Path: /usr/lib/jvm/java-1.7.0-openjdk-amd64/lib
